...
const accounts = [
  ...
  a('11111111-1111-1111-1111-111111111111', '4023600099887766', 'SAVINGS', 'USD', 12890.1),
  a('22222222-2222-2222-2222-222222222222', '4023611122334455', 'CHECKING', 'CAD', 800.0),
  ...
  a('22222222-2222-2222-2222-222222222222', '4023611155667788', 'SAVINGS', 'CAD', 4250.0),
  a(employees[3].employeeId, '4023612200110099', 'CHECKING', 'USD', 3120.55), // Olivia Chen
  a(employees[5].employeeId, '4023612255443322', 'SAVINGS', 'CAD', 18750.4), // Emma Patel
  a(employees[5].employeeId, '4023612266778899', 'CHECKING', 'CAD', 215.2), // Emma Patel
  a(employees[7].employeeId, '4023612277665544', 'CHECKING', 'CAD', 9120.0), // Ava Rodriguez
  a(employees[10].employeeId, '4023612288990011', 'SAVINGS', 'USD', 450.1), // Mia Johnson
  a(employees[12].employeeId, '4023612299887766', 'CHECKING', 'CAD', 2330.85), // Isabella Garcia
  a(employees[18].employeeId, '4023612200334455', 'CHECKING', 'CAD', 6700.0), // Henry Bouchard
  a(employees[25].employeeId, '4023612211223344', 'SAVINGS', 'USD', 0.0, 'CLOSED') // Madison Anderson
];
